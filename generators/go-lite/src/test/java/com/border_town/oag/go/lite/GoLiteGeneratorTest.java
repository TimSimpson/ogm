...
public class GoLiteGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
        .setGeneratorName("go-lite") // use this codegen library
        ...
        // // or from the server
        .setOutputDir("out/go-lite"); // output directory
